...
```{r}
# load data
kr = read.csv("data_fig3_tsayrep.csv")
...
write.csv(lrn_smry,"output_fig3PanelB_STLXJump_meanSEM.csv", row.names = TRUE)
```
...
write.csv(jump_smry,"output_fig3PanelC_STLXJump_meanSEM.csv", row.names = TRUE)
```
