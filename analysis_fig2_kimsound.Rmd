...
```{r}
# load data
ste = read.csv("C:/Users/olivia/Documents/GitHub/TaskSuccessRewardImplicitAdapt/data_fig2_soundtargetsize.csv") # TODO: correct file path
...
write.csv(learningCurveDF,"C:/Users/olivia/Documents/GitHub/TaskSuccessRewardImplicitAdapt/output_fig2_binnedLC_meanSEM.csv", row.names = FALSE)
```
...
write.csv(early_lr_smry,"C:/Users/olivia/Documents/GitHub/TaskSuccessRewardImplicitAdapt/output_fig2_earlyLR_meanSEM.csv", row.names = TRUE)
```
...
write.csv(asym_smry,"C:/Users/olivia/Documents/GitHub/TaskSuccessRewardImplicitAdapt/output_fig2_asym1_meanSEM.csv", row.names = TRUE)
```
...
write.csv(wash_smry,"C:/Users/olivia/Documents/GitHub/TaskSuccessRewardImplicitAdapt/output_fig2_wash_meanSEM.csv", row.names = TRUE)
...
write.csv(noFBBL_smry,"C:/Users/olivia/Documents/GitHub/TaskSuccessRewardImplicitAdapt/output_fig2_noFBBLToneSens_meanSEM.csv", row.names = TRUE)
...
write.csv(noFBBL_sound_smry,"C:/Users/olivia/Documents/GitHub/TaskSuccessRewardImplicitAdapt/output_fig2_noFBBLToneSens_sound_meanSEM.csv", row.names = TRUE)
...
write.csv(FBBL_smry,"C:/Users/olivia/Documents/GitHub/TaskSuccessRewardImplicitAdapt/outpuf_fig2_FBBLToneSens_meanSEM.csv", row.names = TRUE)
...
write.csv(FBBL_tgtSize_smry,"C:/Users/olivia/Documents/GitHub/TaskSuccessRewardImplicitAdapt/output_fig2_FBBLToneSens_tgtSize_meanSEM.csv", row.names = TRUE)
```
